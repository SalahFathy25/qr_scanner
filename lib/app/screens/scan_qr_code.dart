...
import 'package:qr_studio/core/utils/permission_handler.dart';
...
class _ScanQrCodeState extends State<ScanQrCode> {
  ...
  void _onQRViewCreated(QRViewController controller) {
    ...
    controller.scannedDataStream.listen((scanData) async {
      if (!_isDialogOpen && (_result == null || _result!.code != scanData.code)) {
        ...
        final qrUri = Uri.tryParse(qrCode);
  ...
  String _detectCategory(String data) {
    ...
    if (data.startsWith('BEGIN:VCARD') || data.startsWith('BEGIN:vCard')) {
      return 'vcard';
    }
        ...
        content: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                _detectCategory(qrCode).toUpperCase(),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        child: _showHistory ? _buildHistoryView() : _buildScannerView(theme),
      ),
    );
  }
  ...
  Widget _buildHistoryView() {
    return BlocBuilder<ScanHistoryCubit, ScanHistoryState>(
      builder: (context, state) {
        final scans = state is ScanHistoryLoaded
            ? state.scans
            : <QrCodeModel>[];
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          ...
                          onTap: () => QrViewDialog.show(context, scan),
                        );
                      },
                    ),
            ),
